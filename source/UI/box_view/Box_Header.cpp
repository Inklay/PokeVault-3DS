...
m_left(Text(Vec3(55 + m_x_fix, 20, 0), "<")),
m_right(Text(Vec3(250 + m_x_fix, 20, 0), ">")),
m_l(Text(Vec3(65 + m_x_fix, 20, 0), "")),
m_r(Text(Vec3(240 + m_x_fix, 20, 0), "")) {
}
...
void Box_Header::draw_lines(void) {
	...
	// Box name
	C2D_DrawRectSolid(55 + m_x_fix, 20, 0, 210, 30, title_color);
	C2D_DrawRectSolid(50 + m_x_fix, 25, 0, 5, 25, title_color);
	C2D_DrawRectSolid(265 + m_x_fix, 25, 0, 5, 25, title_color);
...
void Box_Header::draw_circles(void) {
	...
	C2D_DrawCircleSolid(55 + m_x_fix, 25, 0, 5, title_color);
	C2D_DrawCircleSolid(265 + m_x_fix, 25, 0, 5, title_color);
